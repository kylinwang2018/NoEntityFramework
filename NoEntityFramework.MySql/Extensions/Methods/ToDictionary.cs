...
namespace NoEntityFramework.MySql
{
    ...
    public static class ToDictionary
    {
        ...
        public static Dictionary<TKey, TValue> AsDictionary<TKey, TValue>(
            this IMySqlQueryable query, int keyColumnIndex, int valueColumnIndex)
        {
        ...
        /// <param name="query">The <see cref="IMySqlQueryable"/> that represent the query.</param>
        /// <returns>A <see cref="Dictionary{TKey,TValue}"/> contains key-value pairs.</returns>
        public static Dictionary<TKey, TValue> AsDictionary<TKey, TValue>(this IMySqlQueryable query)
        {
        ...
        /// <param name="query">The <see cref="IMySqlQueryable"/> that represent the query.</param>
        /// <returns>A <see cref="Dictionary{TKey,TValue}"/> contains key-value pairs as <see langword="string"/>.</returns>
        public static Dictionary<string, string> AsDictionary(this IMySqlQueryable query)
        {
        ...
        /// <param name="query">The <see cref="IMySqlQueryable"/> that represent the query.</param>
        /// <returns>A <see cref="Dictionary{TKey,TValue}"/> contains key-value pairs.</returns>
        public static async Task<Dictionary<TKey, TValue>> AsDictionaryAsync<TKey, TValue>(this IMySqlQueryable query)
        {
        ...
        /// <param name="query">The <see cref="IMySqlQueryable"/> that represent the query.</param>
        /// <returns>A <see cref="Dictionary{TKey,TValue}"/> contains key-value pairs as <see langword="string"/>.</returns>
        public static async Task<Dictionary<string, string>> AsDictionaryAsync(this IMySqlQueryable query)
        {
