...
namespace NoEntityFramework.Sqlite
{
        ...
        where TDbContext : class, ISqliteDbContext
    {
        ...
        public void LogCritical(SqliteCommand sqlCommand, Exception exception,
#if NETSTANDARD2_0
            string message = null)
#else
            string? message = null)
        ...
        public void LogError(SqliteCommand sqlCommand, Exception exception,
#if NETSTANDARD2_0
            string message = null)
#else
            string? message = null)
        ...
        public void LogInfo(SqliteCommand sqlCommand, long timeConsumedInMillisecond,
#if NETSTANDARD2_0
            string message = null)
#else
            string? message = null)
        ...
        public void LogWaring(SqliteCommand sqlCommand, Exception exception,
#if NETSTANDARD2_0
            string message = null)
#else
            string? message = null)
